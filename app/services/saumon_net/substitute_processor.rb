class SaumonNet::SubstituteProcessor
  include ::Loggable
  ...
  def build_substitute_attributes(suppleant_data, stakeholder)
    start_date = SaumonNet::DateParser.parse_datetime(suppleant_data["dateDebut"], session_id: @session_id)
    end_date = SaumonNet::DateParser.parse_datetime(suppleant_data["dateFin"], session_id: @session_id)
